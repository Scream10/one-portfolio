...
export default function Menu() {
  ...
  // useEffect(() => {
  //   const fristMenuTitle = menuTitle.children[0].children[0];
  //   const secondMenuTitle = menuTitle.children[1].children[0];
  //   const thirdMenuTitle = menuTitle.children[2].children[0];
  //   const fourthMenuTitle = menuTitle.children[3].children[0];
  //   const fifthMenuTitle = menuTitle.children[4].children[0];
  //   const sixthMenuTitle = menuTitle.children[5].children[0];

  //   tl.staggerFrom([fristMenuTitle.children[0], secondMenuTitle.children[0], thirdMenuTitle.children[0],
  //     fourthMenuTitle.children[0], fifthMenuTitle.children[0], sixthMenuTitle.children[0]], 1, {
  //     y: 64,
  //     ease: Power3.easeOut,
  //   }, .15)
  // }, [tl]);
